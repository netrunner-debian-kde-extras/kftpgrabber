...
/**
 * This class provides a simple log widget based on QPlainTextEdit.
 *
 * @author Jernej Kos
 */
...
public:
     ...
     * @param type Optional line format type
     */
    void append(const QString &str, LineType type = Plain);
protected:
