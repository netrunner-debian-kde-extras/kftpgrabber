...
Q_OBJECT
public:
    TreeView(QWidget *parent, View *view);
protected:
...
private slots:
    /**
     * Selects and expands the currently viewed entry.
     */
    void selectCurrent();
signals:
    /**
     * Emitted when URLs are dropped to some index.
     *
     * @param url A list of URLs
     * @param index The index they were dropped on
     */
    void urlsDropped(const KUrl::List& urls, const QModelIndex& index);
};
